...
exergonic SN2 reaction (i.e.,
it takes place with a negative ∆G°, releasing energy to the surroundings).
...
A free-energy
diagram for a hypothetical
endergonic SN2 reaction (i.e.,
it takes place with a positive ∆G°, absorbing energy from the surroundings).
...
A modified hourglass that serves as an analogy for a multistep reaction. The overall rate is limited by the rate of the slow step.
...
Reaction (2) leading to the more stable alkene occurs faster than reaction (1) leading to the less stable alkene; ∆G‡ (2) is less than ∆G‡ (1).
...
Free-energy diagram for the addition of HX to an alkene. The free energy
of activation for step 1 is much larger than that for step 2.
...
of HX to an alkene can rearrange to a more stable one
...
A schematic free-energy versus reaction coordinate diagram for the 1,2- and 1,4-addition of HBr to 1,3-butadiene. An allylic carbocation is common to both
pathways. The energy barrier for attack of bromide ion on the allylic cation to form the 1,2-addition product is less than that to form the 1,4-addition product. The 1,2-addition product is **kinetically **favored. The 1,4-addition product is more stable, and so it is the **thermodynamically **favored product.
...
Kinetics and catalytic strategies
...
<div style="position: absolute; left: 16.07%; top: 3.81%; width: 80.35%; height: 11.59%;">

Biochemical systems theory, BST

</div>

<div style="position: absolute; left: 16.07%; top: 15.40%; width: 80.35%; height: 79.21%;">

Bio switch:

<u>https://colab.research.google.com/github/fbeilstein/machine_learning/blob/master/test_basic_functions.ipynb</u>
...
<div style="position: absolute; left: 19.65%; top: 18.95%; width: 80.35%; height: 57.99%;">

**Problem 1. **Calculate ΔH for the process:
...
<div style="position: absolute; left: 19.65%; top: 0.00%; width: 80.35%; height: 12.76%;">

**Problem 2. **You are given data on enzyme kinetics (refer to the table)

</div>

<div style="position: absolute; left: 19.74%; top: 63.26%; width: 77.60%; height: 25.41%;">

Find maximal velocity Vmax and Michaelis constant K_M.

HINT: do not hesitate to use Python, scipy.stats contains linregress function that may help you a lot.
...
**Problem 3. **To the enzyme from the **problem 2** an inhibitor was added. Kinetics changed as follows (see table)

</div>

<div style="position: absolute; left: 19.74%; top: 63.26%; width: 77.60%; height: 25.41%;">

Determine the type of inhibition (competitive, uncompetitive, noncompetitive)

HINT: draw Lineweaver-Burk Plot, do not hesitate to use Python.
