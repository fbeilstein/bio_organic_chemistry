...
![text](22% 48% $$\Delta G^{\ddagger} = G_{\mathrm{X}}^{\ddagger} - G_{\mathrm{S}}$$){color: black}
![text](22% 61% $$\mathrm{S} \longrightarrow \mathrm{X}^{\ddagger} \longrightarrow \mathrm{P}$$){color: black}
[[1,2]]
